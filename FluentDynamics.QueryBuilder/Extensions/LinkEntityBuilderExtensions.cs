...
namespace FluentDynamics.QueryBuilder.Extensions
{
    ...
    public static class LinkEntityBuilderExtensions
    {
        ...
        /// </summary>
        public static LinkEntityBuilder InnerJoin(this LinkEntityBuilder builder, string toEntity,
        ...
        /// </summary>
        public static LinkEntityBuilder LeftOuterJoin(this LinkEntityBuilder builder, string toEntity,
            string fromAttribute,
            string toAttribute,
            Action<LinkEntityBuilder> linkBuilder)
        {
        ...
        /// </summary>
        public static LinkEntityBuilder NaturalJoin(this LinkEntityBuilder builder, string toEntity,
            string fromAttribute,
            string toAttribute,
            Action<LinkEntityBuilder> linkBuilder)
        {
        ...
        /// </summary>
        public static LinkEntityBuilder CrossApplyJoin(this LinkEntityBuilder builder, string toEntity,
            string fromAttribute,
            string toAttribute,
            Action<LinkEntityBuilder> linkBuilder)
        {
        ...
        /// </summary>
        public static LinkEntityBuilder InJoin(this LinkEntityBuilder builder, string toEntity,
            string fromAttribute,
            string toAttribute,
            Action<LinkEntityBuilder> linkBuilder)
        {
        ...
        /// </summary>
        public static LinkEntityBuilder ExistsJoin(this LinkEntityBuilder builder, string toEntity,
            string fromAttribute,
            string toAttribute,
            Action<LinkEntityBuilder> linkBuilder)
        {
        ...
        /// </summary>
        public static LinkEntityBuilder AnyJoin(this LinkEntityBuilder builder, string toEntity,
            string fromAttribute,
            string toAttribute,
            Action<LinkEntityBuilder> linkBuilder)
        {
        ...
        /// </summary>
        public static LinkEntityBuilder NotAnyJoin(this LinkEntityBuilder builder, string toEntity,
            string fromAttribute,
            string toAttribute,
            Action<LinkEntityBuilder> linkBuilder)
        {
        ...
        /// </summary>
        public static LinkEntityBuilder AllJoin(this LinkEntityBuilder builder, string toEntity,
            string fromAttribute,
            string toAttribute,
            Action<LinkEntityBuilder> linkBuilder)
        {
        ...
        /// </summary>
        public static LinkEntityBuilder NotAllJoin(this LinkEntityBuilder builder, string toEntity,
            string fromAttribute,
            string toAttribute,
            Action<LinkEntityBuilder> linkBuilder)
        {
